...
<body>
  <div class="header">
    ...
    <div>
      <div class="doc-title">ORÇAMENTO / CONTRATO</div>
  ...
  <div class="signature-area">
    <div>
      <div class="signature-line">${data.companyName || 'Marcenaria Pro'}<br>Contratada</div>
    </div>
    <div>
      <div class="signature-line">${data.client?.name || 'Cliente'}<br>Contratante</div>
    </div>
  </div>
